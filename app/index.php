    ...
    <body align="center"> 
        ...
        <div id='Trangdieukhien' data-role='page'>
            ...
            <div data-role="content">
                <h1>Data</h1>
                <h4>
                    <a style="margin-left:0%;color: #050505" class="ui-link"> Nhiệt độ(°C) </a>
                    <a style="margin-left:3%;color: #050505" class="ui-link"> Độ ẩm(%) </a>
                    <a style="margin-left:3%;color: #050505" class="ui-link"> Ánh sáng(lx) </a>
                </h4>
                ...
                <div id = 'CamBienSHT31'>
                    <a  id='NoiDungGiamSat1'>
                        <h2>
                            ...
                            <a id="GiaTriNhietDo"style="margin-right: 10%" class="ui-link">0</a>
                            <a id="GiaTriDoAm"style="margin-right: 10%" class="ui-link">0</a>
                            <a id="GiaTriAnhSang" style="margin-left: 2%" class="ui-link">0</a>
                        </h2>
                    </a>
